...
public class NpCommand implements Command {
    ...
    private static final Logger logger = LogManager.getLogger(NpCommand.class.getName());
    ...
    public NpCommand(int steps, Tortoise tortoise) {
        this.steps = steps;
        this.tortoise = tortoise;
    }

    public String toString() {
        return "np " + this.steps;
    }

    @Override
    public void execute() {
        tortoise.goForward(steps);
